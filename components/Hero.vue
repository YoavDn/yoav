...
<template>
  ...
  <div class="hero">
    ...
    >
      <img class="hero-img" src="~~/assets/imgs/hero-img.png" alt="hero-img" />
      <img
        v-if="!showTvLinks"
        class="hero-img-tv"
      ...
      <ul v-if="showTvLinks" class="tv-links">
        <li>
          <a target="_blank" href="https://www.linkedin.com/in/yoav-mendelson/">
  ...
  <div class="scroll-btn flex-col items-center justify-center">
    ...
    <img class="m-auto" src="~~/assets/imgs/down-arrow.svg" alt="down-arrow" />
  </div>
</template>
...
@keyframes doodle {
  ...
  100% {
    ...
    // transform: translate(1px, 0.3px 30deg);
